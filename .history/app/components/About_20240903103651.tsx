      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 md:pl-12">
            ...
            <p className="text-lg mb-4">
              With a commitment to safety, reliability, and customer satisfaction, we have built a reputation as the go-to flatbed trucking company for industries that demand precision and care in their transport needs.
            </p>
            <p className="text-lg">
