...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main>
        <section className="relative py-20 bg-cover bg-center" style={{backgroundImage: "url('https://images.unsplash.com/photo-1586803835585-4496d8b4df8a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')"}}>
