        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 md:pl-12">
            ...
            <p className="text-lg mb-4">
              At PrimeFlatbeds, we haveve been the backbone of North American logistics since 2005. Our fleet of modern flatbed trucks and skilled drivers specialize in hauling challenging loads across the US and Canada.
            </p>
            <p className="text-lg mb-4">
